...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Pets.New(context.Background(), meorphistest9.PetNewParams{
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Pets.New(cancelCtx, meorphistest9.PetNewParams{
		ID:   meorphistest9.F(int64(0)),
		Name: meorphistest9.F("string"),
	})
	if err == nil || res != nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Pets.New(deadlineCtx, meorphistest9.PetNewParams{
			ID:   meorphistest9.F(int64(0)),
			Name: meorphistest9.F("string"),
		})
		if err == nil || res != nil {
