...
describe('resource callbacks', () => {
  test('list: only required params', async () => {
    const responsePromise = meorphisTest44.merchants.callbacks.list({ 'X-Publishable-Key': 'string' });
  ...
  test('list: required and optional params', async () => {
    const response = await meorphisTest44.merchants.callbacks.list({ 'X-Publishable-Key': 'string' });
  });

  test('merchantCallbacksUpdate: only required params', async () => {
    const responsePromise = meorphisTest44.merchants.callbacks.merchantCallbacksUpdate({
  ...
  test('merchantCallbacksUpdate: required and optional params', async () => {
    const response = await meorphisTest44.merchants.callbacks.merchantCallbacksUpdate({
      'X-Publishable-Key': 'string',
