...
describe('resource payments', () => {
  test('guestPaymentsInitialize: only required params', async () => {
    const responsePromise = meorphisTest43.guests.payments.guestPaymentsInitialize({
  ...
  test('guestPaymentsInitialize: required and optional params', async () => {
    const response = await meorphisTest43.guests.payments.guestPaymentsInitialize({
      cart: {
