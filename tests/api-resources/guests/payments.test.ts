...
describe('resource payments', () => {
  test('guestPaymentsInitialize: only required params', async () => {
    const responsePromise = meorphisTest40.guests.payments.guestPaymentsInitialize({
  ...
  test('guestPaymentsInitialize: required and optional params', async () => {
    const response = await meorphisTest40.guests.payments.guestPaymentsInitialize({
      cart: {
