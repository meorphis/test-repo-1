...
from meorphis_test_9._response import (
    APIResponse,
    BaseAPIResponse,
    AsyncAPIResponse,
    BinaryAPIResponse,
...
def test_extract_response_type_direct_class_missing_type_arg() -> None:
    with pytest.raises(
        RuntimeError,
        match="Expected type <class 'meorphis_test_9._response.AsyncAPIResponse'> to have a type argument at index 0 but it did not",
    ):
