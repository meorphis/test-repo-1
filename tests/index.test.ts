...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['MEORPHIS_TEST_42_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new MeorphisTest42({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['MEORPHIS_TEST_42_BASE_URL'] = 'https://example.com/from_env';
      const client = new MeorphisTest42({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['MEORPHIS_TEST_42_BASE_URL'] = ''; // empty
      const client = new MeorphisTest42({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.{username}.dev.bolt.me/v3');
    });

    test('blank env variable', () => {
      process.env['MEORPHIS_TEST_42_BASE_URL'] = '  '; // blank
      const client = new MeorphisTest42({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.{username}.dev.bolt.me/v3');
    });
    ...
    test('env variable with environment', () => {
      ...
      expect(
        () => new MeorphisTest42({ apiKey: 'My API Key', environment: 'production' }),
      ...
      const client = new MeorphisTest42({ apiKey: 'My API Key', baseURL: null, environment: 'production' });
      expect(client.baseURL).toEqual('https://api.{username}.dev.bolt.me/v3');
    });
  });

  test('maxRetries option is correctly set', () => {
    const client = new MeorphisTest42({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new MeorphisTest42({ apiKey: 'My API Key' });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new MeorphisTest42({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new MeorphisTest42({ apiKey: 'My API Key', fetch: testFetch });
