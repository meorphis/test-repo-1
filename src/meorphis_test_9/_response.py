...
from ._exceptions import MeorphisTest9Error, APIResponseValidationError
...
class MissingStreamClassError(TypeError):
    def __init__(self) -> None:
        super().__init__(
            "The `stream` argument was set to `True` but the `stream_cls` argument was not given. See `meorphis_test_9._streaming` for reference",
        )


class StreamAlreadyConsumed(MeorphisTest9Error):
    """
