...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['MEORPHIS_TEST_41_BASE_URL'].
   */
...
/** API Client for interfacing with the Meorphis Test 41 API. */
export class MeorphisTest41 extends Core.APIClient {
  apiKey: string;
   ...
   * @param {string} [opts.baseURL=process.env['MEORPHIS_TEST_41_BASE_URL'] ?? https://api.{username}.dev.bolt.me/v3] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = Core.readEnv('MEORPHIS_TEST_41_BASE_URL'),
    apiKey = Core.readEnv('MEORPHIS_TEST_40_API_KEY'),
    ...opts
  }: ClientOptions = {}) {
    if (apiKey === undefined) {
      throw new Errors.MeorphisTest41Error(
        "The MEORPHIS_TEST_40_API_KEY environment variable is missing or empty; either provide it, or instantiate the MeorphisTest41 client with an apiKey option, like new MeorphisTest41({ apiKey: 'My API Key' }).",
      );
    }
  ...
  static MeorphisTest41 = this;

  static MeorphisTest41Error = Errors.MeorphisTest41Error;
...
export namespace MeorphisTest41 {
