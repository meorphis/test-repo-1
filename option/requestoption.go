...
// RequestOption is an option for the requests made by the meorphis-test-9 API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/meorphis/test-repo#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("http://petstore.swagger.io/v1/")
}
